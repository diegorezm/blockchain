...
export default async function Home() {
  ...
  const features = [
    {icon: Shield, title: "Secure Transactions", description: "Bank-grade encryption for all your trades."},
    {icon: Clock, title: "24/7 Trading", description: "Trade cryptocurrencies anytime, anywhere."},
    {icon: Coins, title: "Low Fees", description: "Competitive rates for all transactions."},
  ] as const
    ...
    <main className="flex flex-col items-center justify-center min-h-screen">
      ...
      >
        ...
        <p className="max-w-2xl mt-4 text-lg md:text-xl text-muted-foreground">
          Unlock the power of decentralized finance and take control of your financial future.
        </p>
        <Link href={isAuth ? "/dashboard" : "/sign-up"} className="w-full mt-6 sm:w-auto">
        ...
        <div className="absolute bottom-0 w-full bg-gradient-to-b from-transparent to-background">
          <div className="h-24" />
          <Link href="#learn-more" aria-label="Learn More" className="inline-flex gap-2">
      ...
      >
        ...
        <p className="mb-8 text-lg text-muted-foreground">
          Explore our key features designed to revolutionize your crypto experience.
        </p>
